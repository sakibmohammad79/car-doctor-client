...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className="h-full rounded-xl flex items-center bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] absolute  left-0 top-0 text-white ">
      ...
      <div>
        <button className="btn btn-primary mr-5 mb-4 md:mb-0">Discover More</button>
        <button className="btn btn-outline btn-secondary">New Project</button>
      </div>
    </div>
    </div>
